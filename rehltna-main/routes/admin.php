...
#------------------------- Routes Auth Users Dashboard -----------------------#
    Route::middleware(['auth', SetTenantConnection::class])->group(function () {
        ...
        Route::middleware('permission:manage_trips')->group(function () {
            ...
            Route::post('/trip-documents/upload-chunk', [ChunkUploadController::class, 'uploadChunk'])->name('trip-documents.upload-chunk');
        ...
        Route::middleware('permission:manage_etisalaty')->group(function () {
            ...
            Route::get('/etisalaty/export-all', [\App\Http\Controllers\Dashboard\EtisalatyController::class, 'exportAll'])->name('etisalaty.export-all');
